...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
    ...
    earthTex = SOIL_load_OGL_texture(TEXTUREDIR"Grass002_1K_Color.JPG", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	lightShader = new Shader("BumpVertex.glsl", "BufferFragment.glsl");
	reflectShader = new Shader("PointLightVertex.glsl", "PointLightFrag.glsl");
	skyboxShader = new Shader("CombineVert.glsl", "CombineFrag.glsl");
